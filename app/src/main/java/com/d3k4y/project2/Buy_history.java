...
public class Buy_history extends AppCompatActivity {

    RecyclerView buy_view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buy_view=findViewById(R.id.buy_history_view);
        buy_view.setLayoutManager(new LinearLayoutManager(getApplicationContext()));

        Query loadProducts= db.collection("ProductBuyDetails").whereEqualTo("buyer_mail",user.getEmail());
        ...
        fsFirestoreRecyclerAdapter=new FirestoreRecyclerAdapter<BuyModel, HistoryHolder>(recyclerOptions){
            ...
            protected void onBindViewHolder(@NonNull HistoryHolder holder, int position, @NonNull BuyModel model) {
                holder.h_seller_mail.setText("Seller mail :-");
                holder.h_buy_mail.setText(model.getSeller_mail());
        ...
        buy_view.setAdapter(fsFirestoreRecyclerAdapter);
